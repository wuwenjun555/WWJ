...
(function (win) {
  ...
  $.setORP(A0UI.prototype, {
    ...
    ena: function () { return eachA0UI(this, function (i, v) { v.removeAttribute('disabled'); /*TODO: restore tabIndex from cache */ }); },
    dis: function () { return eachA0UI(this, function (i, v) { v.setAttribute('disabled'); }); /*TODO: cache tabIndex */ },
