$.db =
{
  "awsSAP": [
    ...
    },
    {
      ...
      "q_cn": "一家公司希望使用 AWS 为本地应用程序进行灾难恢复。该公司拥有数百台运行该应用程序的基于Windows的服务器。所有服务器都装载一个公共共享。该公司的 RTO 为 15 分钟，RPO 为 5 分钟。该解决方案必须支持本机故障转移和 falback 功能。哪种解决方案最经济高效地满足这些要求？",
      "a_cn": [
    ...
    },
    {
      ...
      "aa": "D",
      "qK": "RPO of 2 minutes,RTO of 30 minutes",
      "aK": [
        "DLM",
        "cross-Region"
      ]
