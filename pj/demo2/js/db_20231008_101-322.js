  ...
  "awsSAP": [
    {
      ...
      "aK": ["AWS Config,Enable all features,AWS Firewall Manager"]
    },
    {
      "no": 282,
      ...
      "aK": ["SCT,Configure VPC peering,DMS,full load plus,CDC"]
    },
    {
      "no": 283,
    ...
    },
    {
      ...
      "aK": ["Create a dedicated transit gateway,each VPC attachment"]
    },
    {
      "no": 287,
    ...
    },
    {
      ...
      "aK": ["private VIF,Create an Amazon S3 interface endpoint"]
    },
    {
      "no": 291,
      ...
      "aK": ["IAM user in the management account,cross-account roles"]
    },
    {
      "no": 296,
      ...
      "aK": ["Run the EC2,minimum capacity,Increase"]
    },
    {
      "no": 299,
    ...
    },
    {
      ...
      "aa": "A",
      "qK": "Amazon WorkSpaces,replace aging desktops",
      "aK": ["Create an IP access control group"]
    },
    {
      "no": 301,
      ...
      "aK": ["Turn on the cross-account management feature in AWS Backup"]
    },
    {
      "no": 302,
    ...
    },
    {
      ...
      "aa": "D",
      "qK": "next 6 months,90%",
      "aK": ["Configure a cross-Region,geolocation routing"]
    },
    {
      "no": 307,
    ...
    },
    {
      ...
      "aa": "B",
      "qK": "four Amazon EC2",
      "aK": ["Create,Attach the existing EC2"]
    },
    {
      "no": 312,
    ...
    },
    {
      ...
      "aK": ["private repository,allows only"]
    },
    {
      "no": 320,
      ...
      "aK": ["Configure an Amazon Cognito user pool"]
    },
    {
      "no": 321,
    ...
    },
    {
      ...
      "aK": ["DocumentDB (with MongoDB,appropriately sized"]
    },
    {
      "no": 101,
      ...
      "aK": ["Application Discovery Agent,Migration Hub"]
    },
    {
      "no": 102,
      ...
      "q_cn": "出版公司的设计团队更新电子商务 Web 应用程序使用的图标和其他静态资产。该公司从托管在公司生产账户中的 Amazon S3 存储桶提供图标和资产。该公司还使用设计团队成员可以访问的开发账户。n设计团队测试开发账户中的静态资产后，设计团队需要将资产加载到生产账户中的 S3 存储桶中。解决方案架构师必须为设计团队提供对生产帐户的访问权限，而不会使 Web 应用程序的其他部分面临不需要的更改的风险。n哪种步骤组合将满足这些要求？（选择三个。",
      "a_cn": [
        "",
        "",
        "",
    ...
    },
    {
      ...
      "aa": "C",
      "qK": "international delivery company",
      "aK": ["SNS"]
    },
    {
      "no": 121,
    ...
    },
    {
      ...
      "q_cn": "一家公司在 eu-west-1 区域运行其应用程序，并且其每个环境都有一个帐户：开发、测试和生产。所有环境每周 7 天、每天 24 小时运行，使用有状态 Amazon EC2 实例和适用于 MySQL 数据库的 Amazon RDS。数据库的大小介于 500 GB 和 800 GB 之间。n开发团队和测试团队在工作日的工作时间工作，但生产环境每周 7 天、每天 24 小时运行。该公司希望降低成本。所有资源都使用环境标记进行标记，其中开发、测试或生产作为密钥。n解决方案架构师应如何以最少的运营工作量降低成本？",
      "a_cn": [
        "",
        "",
        "",
    ...
    },
    {
      ...
      "aa": "C",
      "qK": "VMware ESXi",
      "aK": ["Migration Evaluator agentless,ESXi hypervisor"]
    },
    {
      "no": 179,
      "q": "",
    ...
    },
    {
      ...
      "aK": ["increase,fan-out,error retry"]
    },
    {
      "no": 194,
      "q": "",
    ...
    },
    {
      ...
      "aK": ["S3,Systems Manager Parameter Store"]
    },
    {
      "no": 11,
    ...
    },
    {
      ...
      "aK": ["Create an authorization,associate,Associate"]
    },
    {
      "no": 19,
      ...
      "q_cn": "天气服务通过托管在欧洲西部 1 区域的 AWS 上的 Web 应用程序提供高分辨率天气图。天气图会经常更新，并与静态 HTML 内容一起存储在 Amazon S3 中。Web 应用程序由 Amazon CloudFront 前端。n该公司最近扩展到为 us-east-1 区域的用户提供服务，这些新用户报告说，查看各自的天气图时不时很慢。n哪些步骤组合将解决 us-east-1 的性能问题？（选择两个。",
      "a_cn": [
        "",
        "",
        "",
    ...
    },
    {
      ...
      "aK": ["Multi-AZ,Kinesis Data Firehose"]
    },
    {
      "no": 215,
    ...
    },
    {
      ...
      "aK": ["Deploy a single NAT gateway,CloudWatch"]
    },
    {
      "no": 230,
    ...
    },
    {
      ...
      "aK": ["Route 53 health check,IoT Core domain"]
    },
    {
      "no": 236,
    ...
    },
    {
      ...
      "aK": ["Enable the appropriate guardrail,recommended"]
    },
    {
      "no": 246,
      "q": "A media storage application uploads user photos to Amazon S3 for processing. End users are reporting that some uploaded photos are not being processed properly. The Application Developers trace the logs and find that AWS Lambda is experiencing execution issues when thousands of users are on the system simultaneously. Issues are caused by:\n - Limits around concurrent executions.\n - The performance of Amazon DynamoDB when saving data.\nWhich actions can be taken to increase the performance and reliability of the application?(Choose two.) ",
    ...
    },
    {
      ...
      "aK": ["AWS Batch,Kinesis Data Firehose,S3,50%"]
    },
    {
      "no": 253,
      ...
      "aK": ["NACL,interface endpoint subnets,clients."]
    },
    {
      "no": 263,
    ...
    },
    {
      ...
      "aK": ["Create a transit gateway,share it"]
    },
    {
      "no": 268,
    ...
    },
    {
      ...
      "q_cn": "一家公司计划在 VPC 内的 Amazon EC2 实例上部署新的私有内联网服务。AWS 站点到站点 VPN 将 VPC 连接到公司的本地网络。新服务必须与现有本地服务通信。可以使用驻留在公司中的主机名访问本地服务。示例 DNS 区域。此 DNS 区域完全托管在本地，并且仅在公司的专用网络上可用。n解决方案架构师必须确保新服务可以解析公司示例域上的主机名，以便与现有服务集成。n哪种解决方案满足这些要求？",
      "a_cn": [
        "",
        "",
        "",
      ...
      "aK": ["Turn on DNS hostnames,outbound"]
    },
    {
      "no": 274,
    ...
    },
    {
      ...
      "aK": ["Configure scan on push on the repository,EventBridge,SNS"]
    },
    {
      "no": 276,
      ...
      "aK": ["IoT Core,Kinesis Data Firehose"]
    },
    {
      "no": 278,
    ...
    },
    {
      ...
      "aK": ["Use AWS Elastic Disaster Recovery,FSx,Windows File Server"]
    },
    {
      "no": 100,
